...
```
  /**
  * added data-search-term attribute to found search terms with hexColor specified
  * also changed mouse selection end to be on mouseup so user can take their time
  * making a selection
  */
  searchOptions?: {
    searchTerms?: {
