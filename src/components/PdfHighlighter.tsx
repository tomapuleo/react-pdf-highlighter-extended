...
>(function PdfHighlighter(
  ...
  const fixHilightingSearchTerms = () => {
    ...
    const spans = document.querySelectorAll(
      `.pdfViewer [data-loaded='true'] .textLayer span[dir='ltr']`,
    );
